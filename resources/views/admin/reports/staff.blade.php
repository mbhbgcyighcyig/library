...
@section('title', 'Laporan Petugas - Admin Bookify')
...
<div class="card-box">
    <div style="display:flex;justify-content:space-between;align-items:center;margin-bottom:16px;">
        <div class="card-title" style="margin-bottom:0;">Laporan Petugas ({{ $staff->count() }} petugas)</div>
    ...
    <table class="tbl">
        ...
        <tbody>
            ...
            @empty
            <tr><td colspan="6" style="text-align:center;color:#aaa;padding:30px;">Belum ada petugas.</td></tr>
            @endforelse
        </tbody>
    </table>
</div>
