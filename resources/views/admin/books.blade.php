...
<div class="card-box">
    ...
    <form action="{{ route('admin.books.store') }}" method="POST">
        ...
        <div style="display:grid;grid-template-columns:repeat(3,1fr);gap:12px;margin-bottom:12px;">
            ...
            <input type="number" name="published_year" class="form-field" placeholder="Tahun Terbit" min="1900" max="2099">
            <input type="number" name="stock" class="form-field" placeholder="Stok" min="0" required>
            <div style="grid-column:1/-1;">
                <input type="text" name="summary" class="form-field" placeholder="Ringkasan buku (opsional)">
            </div>
        </div>
        <button type="submit" class="btn-primary"><i class="fas fa-plus"></i> Tambah Buku</button>
    </form>
</div>
    ...
    <div style="overflow-x:auto;">
        <table class="tbl">
            ...
            <tbody>
                ...
                @empty
                <tr><td colspan="8" style="text-align:center;color:#aaa;padding:30px;">Belum ada buku.</td></tr>
                @endforelse
            </tbody>
        </table>
    </div>
