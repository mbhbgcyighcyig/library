...
@section('title', 'Dashboard Petugas - Bookify')
...
<div class="stats-row">
    ...
    <div class="stat-card">
        ...
        <div class="stat-num">{{ $menunggu_kembali }}</div>
    </div>
    <div class="stat-card">
                ...
                <tr>
                    ...
                    <td>
                        ...
                        @elseif($borrow->status === 'menunggu_kembali')
                            <span class="badge-blue">Minta Kembali</span>
                        @elseif($borrow->status === 'dikembalikan')
                            <span class="badge-gray">Dikembalikan</span>
                        @else
                            <span class="badge-red">{{ ucfirst($borrow->status) }}</span>
                        @endif
                    </td>
                </tr>
                @empty
